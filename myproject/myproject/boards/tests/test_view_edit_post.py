...
#testa se a view ta protegida com o @login_decorator
...
#cria um novo usuario diferente do q postou e tenta acessar a pagina de edicao
# so o proprietaro deve acessa-la
...
#vai ser reutilizada em outros testes
#testes basicos de criacao de usuarios, topicos, quadros
